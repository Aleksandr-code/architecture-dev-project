...
class Vector
{
    ...
    static function MultiplicateTwoVector(Vector $first, Vector $second):Vector
    {
        $newVector = new Vector($first->x, $first->y);
        $newVector->x += $newVector->x * $second->x;
        $newVector->y += $newVector->y * $second->y;
        return $newVector;
    }
}