...
Цель: Научиться обрабатывать ситуации с точки зрения SOLID, когда требуется уточнить существующее поведение без модификации существующего кода.<br>
...
5. Реализовать команду-повторитель, которая ставит в очередь другую команду. С помощью неё реализовать длительную операцию Движение по прямой.